            ...
            <div className="row-fluid">
              ...
              <div className="col-md-6 col-sm-6 hidden-xs text-right">
                ...
                >
                  ...
                  <a
                    className="youtube"
                    href="https://youtube.com/@petersplim?si=BOl0c-jtyp27qIEM"
                    title="YouTube"
                  >
                    <i className="fab fa-youtube" />
                  </a>
                  <a className="avatar" href="#" title="Profile">
                    <i
              ...
              <div className="logo-normal">
                <Link className="navbar-brand" to="/" style={{ display: 'flex' }}>
                  <img
                    src={wisePl}
                    alt="WisePl_logo"
                    style={{ width: '98%', borderRadius: '5px', marginBottom:'450px' }}
                  />
                </Link>
              </div>
              <button
            ...
            <div id="navbar" className="navbar-collapse collapse">
              ...
              >
                ...
                <li className="dropdown yamm-fw yamm-half">
                  ...
                  >
                    Programs <b className="fa fa-angle-down" />
                  </Link>
